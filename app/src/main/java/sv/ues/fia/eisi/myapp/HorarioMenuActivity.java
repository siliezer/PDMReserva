...
public class HorarioMenuActivity extends ListActivity {
    ...
    String[] menu = {"Agregar Horario","Eliminar Horario","Consultar Horario",
            "Actualizar Horario"};
    String[] activities ={"HorarioInsertarActivity","HorarioEliminarActivity","HorarioConsultarActivity",
