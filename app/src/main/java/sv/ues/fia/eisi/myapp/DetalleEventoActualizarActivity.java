...
public class DetalleEventoActualizarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_evento_actualizar);
    ...
    public void actualizarDetalleEvento(View v){
        ...
        helper.abrir();
        regInsertados = helper.actualizar(detalleevento);
        helper.cerrar();
